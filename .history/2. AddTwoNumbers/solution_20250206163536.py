...
print(linked_list_to_list(result))  # Expected Output: [7, 0, 8]

# Test Case 2
l1 = list_to_linked_list([0])
l2 = list_to_linked_list([0])
result = solution.addTwoNumbers(l1, l2)
print(linked_list_to_list(result))  # Expected Output: [0]

# Test Case 3
l1 = list_to_linked_list([9, 9, 9, 9, 9, 9, 9])
l2 = list_to_linked_list([9, 9, 9, 9])
result = solution.addTwoNumbers(l1, l2)
print(linked_list_to_list(result))  # Expected Output: [8, 9, 9, 9, 0, 0, 0, 1]
